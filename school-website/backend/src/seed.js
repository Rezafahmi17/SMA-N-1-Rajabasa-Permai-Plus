...
async function seed() {
  ...
  if (!existingAdmin) {
    ...
    console.log(`Admin default dibuat -> username: ${username}`);
  } else {
    ...
    await Ekstrakurikuler.bulkCreate([
      {
        nama: "Pramuka",
        deskripsi:
          "Kegiatan kepanduan untuk melatih kemandirian dan kedisiplinan siswa.",
        pembina: "Bpk. Andi",
      },
      {
        nama: "Basket",
        deskripsi: "Latihan rutin setiap hari Sabtu di lapangan sekolah.",
        pembina: "Bpk. Rudi",
      },
      {
        nama: "Paduan Suara",
        deskripsi: "Mengasah bakat seni suara siswa untuk acara-acara sekolah.",
        pembina: "Ibu Sari",
      },
    ]);
